...
import styles from './page.module.css'; // Importa o arquivo de estilos específico desta página
...
export default function Sobre() {
    return (
        <div>
            ...
            {/* Seção principal para versões desktop */}
            <main className={styles.main}>
               {/* Primeira seção: Nossa Missão */}
               <section className={styles.sectionOne}>
                ...
                {/* Quarta seção: Nossos Compromissos */}
                <section className={styles.sectionFour}>
                    ...
                    <div className={styles.textContainer}>
                        ...
                        <div className={styles.container_right}>
                            {/* Descrição detalhada dos compromissos */}
                            <p className={styles.description}>
